...
```typescript
// entities/user/model/user.type.ts
...
```typescript
// entities/user/model/user.logic.ts
import type { User, UserDTO, UserRole } from './user.type';
...
import { mapUserDTO } from '../model/user.logic';
import type { User, UserDTO } from '../model/user.type';
...
import { getCurrentUser, getUserById, updateUser } from './user-api';
...
export { getCurrentUser, getUserById } from './api/user-api';
export { useCurrentUser, useUser, userKeys } from './api/queries';
export type { User, UserRole, UserDTO } from './model/user.type';
export { mapUserDTO } from './model/user.logic';
...
```typescript
// features/auth/model/auth.type.ts
...
import type { LoginCredentials, RegisterData, AuthTokens } from '../model/auth.type';
...
export { login, register, logout } from './api/auth-api';
export type { LoginCredentials, AuthTokens } from './model/auth.type';
...
```tsx
// pages/product-detail/ui/product-detail-page.tsx
...
export function Button({ ref, variant = 'primary', loading, children, disabled, ...props }: ButtonProps) {
  return (
    <button
      ref={ref}
